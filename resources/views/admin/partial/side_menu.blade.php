 <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="#" method="get" class="sidebar-form">
        <div class="input-group">
          <input type="text" name="q" class="form-control" placeholder="post Search...">
          <span class="input-group-btn">
                <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
                </button>
              </span>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Reports</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Users</a></li>
             <li><a href="index2.html"><i class="fa fa-circle-o"></i> Suggestions</a></li>
          </ul>
        </li>
